...
import com.vatas.interfaces.model.ClienteDaoInterface;

import com.vatas.model.daos.ClienteDao;
import com.vatas.model.dtos.Cliente;
import com.vatas.factory.EntityManager_Factory;

/**
 * @Autor: Arnold Herrera
 * @Date: 31/03/2019
 * @Project: concesionario_spring
 * @FileName:ClienteDao.java Copyrigt(C) 2019 Todos los derechos reservados.
 */
public class ClienteDao implements ClienteDaoInterface {

	EntityManager_Factory emf = new EntityManager_Factory();
	...
	public void crearCliente(Cliente cliente) {
		...
		try {
			...
			Logger.getLogger(getClass()).log(Level.ERROR,
					"Error when saving 'Cliente' in Database EXCEPTION STRING: {0}" + e.getMessage());
